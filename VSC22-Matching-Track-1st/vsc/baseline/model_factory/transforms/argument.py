...
class RandomOverlayCorners(BaseTransform):
    ...
    def __init__(self, always_apply=False, p=0.5):
        ...
        self._c1 = Image.open("/mnt/nanjing3cephfs/mmvision/tyewang/projects/datas/meta-challenge/src/1_bg.png")
        self._c2 = Image.open("/mnt/nanjing3cephfs/mmvision/tyewang/projects/datas/meta-challenge/src/2_bg.png")
        self._c3 = Image.open("/mnt/nanjing3cephfs/mmvision/tyewang/projects/datas/meta-challenge/src/3_bg.png")
        self._c4 = Image.open("/mnt/nanjing3cephfs/mmvision/tyewang/projects/datas/meta-challenge/src/4_bg.png")
...
class RandomOverlayImages(RandomStackImages):
    ...
    def _transform(self, image):
        ...
        if np.random.random() < 0.5:
            overlay_img, img = img, overlay_img

        opacity = np.random.uniform(0.2, 0.7)
        overlay_size = np.random.uniform(0.5, 1.)
        img = OverlayImage(overlay_img, opacity=opacity, overlay_size=overlay_size,
                           # x_pos=0., y_pos=0,
